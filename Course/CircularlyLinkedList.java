...
public class CircularlyLinkedList<E> {
  ...
  public static int mySize(CircularlyLinkedList li) {
	  int count = 0;
	  while(li.tail != null) {
		  li.removeFirst();
		  count++;
  ...
  public CircularlyLinkedList<E> clone() throws CloneNotSupportedException {
      ...
      CircularlyLinkedList<E> other = new CircularlyLinkedList<>(); // safe cast
...
//main method
  public static void main(String[] args) throws CloneNotSupportedException
  {
	  ...
	  CircularlyLinkedList<String> newList = circularList.clone(); // clone the list
      System.out.println("\ncloned list : " + newList);
  }
}
